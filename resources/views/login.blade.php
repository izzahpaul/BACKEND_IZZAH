...
<main class="form-signin w-100 m-auto">
  <h1 class="h2 mb-3 fw-bold text-center">LOGIN</h1>
  <form>
    ...
    <button class="btn btn-success w-100 py-2" type="submit"><a href="/dashboard" class="ling text-white">Login</a></button>
